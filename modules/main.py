...
def main():
    ...
    if args.bicimad:
        ...
        if args.todas:
            ...
            print(place_especific.to_csv('./modules/bicimad_result.csv', index=False, encoding= 'utf-8'))
        ...
        if args.todas:
            ...
            place_especific.to_csv('./modules/bicipark_result.csv', index=False, encoding= 'utf-8')
